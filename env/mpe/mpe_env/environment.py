...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(
        ...
        self.max_num_agents, self.max_num_entities = world.num_agents, world.num_entities
        # scenario callbacks
    ...
    def step(self, action_n):
        ...
        for _ in range(self.n_agents - len(self.agents)):
            obs_n.append(np.zeros(obs_n[0].shape[0]))
            reward_n.append(0.0)
            done_n.append(True)
            info['n'].append({})
    ...
    def get_task_id(self):
        return self.id_callback(self.world)
    ...
    def render(self, mode='human'):
        ...
        for i in range(len(self.viewers)):
            ...
            if self.viewers[i] is None:
                ...
                from env.mpe.mpe_env import rendering
